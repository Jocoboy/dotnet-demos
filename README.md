![workflow on abpdemo branch](https://github.com/Jocoboy/dotnet-demos/actions/workflows/abp-framework.yml/badge.svg?branch=abpdemo)  
...
- :white_check_mark: Use Redis Distributed Cache to manage business information.
- :white_check_mark: Use Redis Distributed Locking to update values with Distributed Lock.
